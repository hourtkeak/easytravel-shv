	...
	<section class="container tm-home-section-1" id="more">
		<div class="row">
			...
			<div class="flexslider effect2 effect2-contact tm-contact-box-1">
				<ul class="slides">
					 <?php
$stmt_about = $DB_con->prepare("SELECT c_id, c_title, c_is_show, c_desc, c_headline, c_main_id FROM menu  WHERE c_id=4 AND c_is_show=1 order by c_id ASC");
$stmt_about->execute();
$result_about = $stmt_about->fetch(PDO::FETCH_ASSOC);?>
