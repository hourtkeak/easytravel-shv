 ...
 <div class="box">
  ...
  <div class="box-body table-responsive">
	...
	*/
	$query = $DB_con->prepare("SELECT COUNT(*) as num FROM content 
				LEFT JOIN menu ON content.cat_id=menu.c_id 
				LEFT JOIN images ON content.id=images.id_article
				LEFT JOIN users on content.member_id = users.user_id
	...
	$targetpage = "sr-admin.php?page=content"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$result=$DB_con->prepare("SELECT content.id, content.text_title, content.modified_date,  content.display, content.sort, menu.c_id,  menu.c_title, images.img_thumbnail, users.user_name FROM content 
				LEFT JOIN menu ON content.cat_id=menu.c_id 
				LEFT JOIN images ON content.id=images.id_article
				LEFT JOIN users on content.member_id = users.user_id
...
?>
                 ...
                 <tr>
                                                <td><?php echo $i ?></td>
                                                 <td>
                                                    ...
                                                    <span class="help-block">
                                                        ...
                                                        images:&nbsp; <?php if(!empty($row['img_thumbnail'])) echo $row['img_thumbnail'];
                                                                else echo "No Images";
                                                        ?>
                                                        </span>
                                                 </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="sr-admin.php?page=content&action=edit&id_article=<?php echo $row['id']; ?>">
                                                    Edit
                                                    </a>
                                                </td>
                                            </tr>
