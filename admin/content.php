...
<div class="box box-solid box-primary ">
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
     ...
     <a href="sr-admin.php?page=content_list" class="btn btn-block btn-primary btn-sm"> View all menu</a>
    </div><!-- /.box-tools -->
  </div><!-- /.box-header -->
  <div class="box-body">
...
?>">
	...
	<div class="form-group">
     ...
     <div class="form-group">
		...
		<textarea id="textarea1" name="full_article" class="form-control tinymce"  rows="15" style="width:100%; height: 300px;"><?php echo @$result_article["full_text"]; ?></textarea>
    </div>
    <div class="form-group">
    ...
    <?php if($userRow['u_level']==2 or $userRow['u_level']==1){ ?>
    <div class="checkbox">
        <label>
